    ...
    class LogEventTask extends AsyncTask<String, Void, String>  {
		...
		protected String doInBackground(String... event_json) {
			...
			try {
		        ...
		        String authorizationString = Base64.encodeToString((projectCode + ":" + apiSecret).getBytes(), Base64.NO_WRAP);
		        httpPost.setHeader("Authorization", "Basic " + authorizationString);
